...
const PatientLogin = () => {
  ...
  return (
    <div className="medical-bg min-h-screen flex items-center justify-center px-4 py-8">
      <div className="max-w-md w-full fade-in">
        <div className="glass-card float-in">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-800 mb-1">QuickLine</h1>
            <p className="text-gray-600 text-sm mb-6">Access your hospital queue & appointments</p>
          </div>
          ...
          <div className="role-selector">
            <div 
              className={`role-option ${
                userRole === 'patient' ? 'active' : 'inactive'
              }`}
            ...
            <div 
              className={`role-option ${
                userRole === 'staff' ? 'active' : 'inactive'
              }`}
